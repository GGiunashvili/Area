...
var resultOptions = [
    ...
    {   title: '<p class="product-name-title">ჩვენი აზით შენს 💜-ს გაუხარდება</p>',
        desc: '<p class="product-name">კაცის საათი 1</p><a href="https://extra.ge/detailed/eleqtronika/kompiuteruli-teqnika/noutbuqis-aqsesuarebi/qursasmeni/qursasmeni-marshall-major-iii-bluetooth-black-4235" ></p><img src="image/valentines-1.png"/></a> <div class="result-button-box"><a class="sex-box__btn "> <p class="sex-box__btn__p">განაგრძე შოპინგი</p> </a> <a class="sex-box__btn result-button-box__second-btn"> <p class="sex-box__btn__p">დაათვალიერე პროდუქცია</p> </a></div>'},
    {   title: '<p class="product-name-title">ჩვენი აზით შენს 💜-ს გაუხარდება</p>',
        desc: '<p class="product-name">მამაკაცის ნაკრები 2222</p><a href="https://extra.ge/detailed/eleqtronika/kompiuteruli-teqnika/noutbuqis-aqsesuarebi/qursasmeni/qursasmeni-marshall-major-iii-bluetooth-black-4235" ></p><img src="image/valentines-2.png"/></a> <div class="result-button-box"><a class="sex-box__btn "> <p class="sex-box__btn__p">განაგრძე შოპინგი</p> </a> <a class="sex-box__btn result-button-box__second-btn"> <p class="sex-box__btn__p">დაათვალიერე პროდუქცია</p> </a></div>'},
    {   title: '<p class="product-name-title">ჩვენი აზით შენს 💜-ს გაუხარდება</p>',
    ...
    {   title: '<p class="product-name-title">ჩვენი აზით შენს 💜-ს გაუხარდება</p>',
        desc: '<p class="product-name">წიგნი სამსახურს 444</p><a href="https://extra.ge/detailed/eleqtronika/kompiuteruli-teqnika/noutbuqis-aqsesuarebi/qursasmeni/qursasmeni-marshall-major-iii-bluetooth-black-4235" ></p><img src="image/bichiswigni.png"/></a> <div class="result-button-box"><a class="sex-box__btn "> <p class="sex-box__btn__p">განაგრძე შოპინგი</p> </a> <a class="sex-box__btn result-button-box__second-btn"> <p class="sex-box__btn__p">დაათვალიერე პროდუქცია</p> </a></div>'},
